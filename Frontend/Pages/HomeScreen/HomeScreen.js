        ...
        <View style={styles.secondBackground}>
          <View style={styles.insightContainer}>
            ...
            <View style={styles.insightsRow}>
              <TouchableOpacity style={styles.insightBoxContainer} onPress={() =>  navigation.navigate("EmergencyList")} >
                <View>
          ...
          <View style={styles.rideInProgress}>
            ...
            <Text style={styles.rideDetails}>
              Start your race with enhanced safety features and real-time
              monitoring for a secure journey
            </Text>
